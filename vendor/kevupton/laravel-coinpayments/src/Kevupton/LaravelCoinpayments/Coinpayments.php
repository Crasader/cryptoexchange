...
class Coinpayments
{
     ...
     * @return array|mixed
     */
    public function createTransactionSimple($amount, $amountBtc, $currencyIn, $currencyOut, $userId, $plan, $buyerName, $buyerEmail)
    {
        $acceptableFields = [
            'address', 'buyer_email', 'buyer_name', 'user_id',
