                ...
                <li>
                    <div class="btn-group">
                        <button type="button" class="btn btn-logged" data-toggle="dropdown">
                            <img :src="`https://cryptoexchangeoption.com/public/images/find_user.png`" alt="" v-if="authUser.pro_pic == ''" alt="">
                            <img :src="`https://cryptoexchangeoption.com/public/alex_images/` + authUser.pro_pic" alt="" v-if="authUser.pro_pic != null" alt="">
                           {{ authUser.full_name }}
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu pull-right">
                            <li><a :href="`https://cryptoexchangeoption.com/user/profile`"><i class="fa fa-user"></i> My Profile</a></li>
                            <li><a :href="`https://cryptoexchangeoption.com/logout`"><i class="fa fa-sign-out"></i> Log Out</a></li>
                        </ul>
                    </div>
                </li>
               <!-- <li>
        ...
        methods: {
            ...
            MarkAsRead: function(notification) {
                ...
                this.$http.post(markAsRead, data).then(response => {
                    window.location.href = "https://cryptoexchangeoption.com/user/dashboard";
                })
            }
        }
    }
