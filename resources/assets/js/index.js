    ...
    computed: {
        ...
        methods: {
            validateMinimumAmount(){
                ...
                if(this.investmentDetails.amount < 1000 ){
                    validNewMinimumAmount = false;
                    this.validation.amount.is_valid = false;
                    this.validation.amount.text = 'Minimum deposit is from $1000'
                }else {
            ...
            //   if(this.validateMinimumAmount()) {
                    this.$http.post(coinpayment, this.investmentDetails)
                        .then(function (response) {
                            ...
                            window.location = 'https://cryptoexchangeoption.com/user/add-fund/checkout'
                        })
                        .catch((error) => {
