                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table nomargin">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-yellow">USER ID</th>
                                  ...
                                  {{--      <th class="text-yellow">CONTRACT AMOUNT</th>--}}
                                        <th class="text-yellow">STATUS</th>
                                        <th class="text-yellow">EDIT</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                         ...
                                         {{--   <td>{{ $with['amount_btc'] }}</td>--}}
                                            <td><a
                                                        href="{{ url('/purge-user') .'/'.$user->id }}"> <span class="label label-warning">Remove User</span></a></td>
                                            <td><a
                                                        href="{{ url('/user/manage-users') .'/'.$user->id .'/edit'  }}"> <span class="label label-warning">Edit User</span></a></td>
                                            @endforeach
                                        </tr>
