                                ...
                                <tr>
                                    ...
                                    {{-- <td>
                                        <ul class="table-options">
                                            <li><a href="{{ url('/user/admin-withdrawals') .'/'.$withdraw->id .'/edit'  }}"><span class="label label-warning"></span></a></li>
                                        </ul>
                                    </td>
                                    <td>
                                        <ul class="table-options">
                                            <li><a onclick="delete_withdrawal('{{$withdraw->id}}');"  href="{{ route('admin.delete-withdrawal', ['id' =>$withdraw->id]) }}"><span class="label label-success"></span></a></li>
                                        </ul>
                                    </td>--}}


                                    <td><a href="{{ url('/user/admin-withdrawals') .'/'.$withdraw->id .'/edit'  }}"> <span class="label label-warning">Edit Withdrawal</span></a></td>

                                  <td><a onclick="delete_transaction('{{$withdraw->id}}');"  href="{{ route('admin.delete-withdrawal', ['id' =>$withdraw->id]) }}"> <span class="label label-warning">Delete Withdrawal</span></a></td>
